...
public class ManualControl extends Frame implements KeyListener, Runnable {
	...
	public void keyReleased(KeyEvent e) {
		int keyCode = e.getKeyCode();
		// if (keyCode >= KeyEvent.VK_1 && keyCode <= KeyEvent.VK_9) speed =
		// (float)0.1; //Reset speed
	...
	public void control(int keyCode) throws Exception {
		...
		case KeyEvent.VK_SPACE:
			...
			if (space_bar && !mMainbus.isStarted()) {
				...
				// space_bar = false;
				// new
				// MatFileHandler().createMatFileFromFlightData("FlightData",
				// NavDataOverAll);
				// new
				// MatFileHandler().createMatFileFromFlightData("ControlData",
				// ControlSignalAll);
				ControlSignal[0] = 0;
				mMainbus.setControlSignal(ControlSignal);
			}
