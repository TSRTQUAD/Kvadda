...
public class kalman_2xreadings {
		...
		public kalman_2xreadings(double sampletime,double lambdaxdot,double lambdaygps,double lambdayvel,
			...
			Hvel = new SimpleMatrix(1,2,true,((double)1),((double)0));
		...
		public double[] velmeasurementupdate(double velobservation){	
	        ...
	        //S.print();
	        // K = PH'S^(-1)
	        this.Kvel = P.mult(Hvel.transpose().mult(S.invert()));
	        //K.print();
	        // x = x + Ky
